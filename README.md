...
This project is a web scraping tool developed to collect detailed information about books from Amazon. It retrieves data such as title, rating, description, and authors.
